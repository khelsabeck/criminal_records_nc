...
def level1_convictions_onepoint():
    ...
    con1 = Conviction("PSG", "Class 1 Misdemeanor", date(2015,1, 1), "Randolph County", "14-72")
...
def level1_convictions_nopoints():
    ...
    con1 = Conviction("Shoplifting", "Class 3 Misdemeanor", date(2015,1, 1), "Randolph County", "14-72")
...
def level2_convictions_2points():
    ...
    con1 = Conviction("PSG", "Class 1 Misdemeanor", date(2015,1, 1), "Randolph County", "14-72")
    con2 = Conviction("PSG", "Class 1 Misdemeanor", date(2015,2, 2), "Randolph County", "14-72")
...
def level2_convictions_fivepoints():
    ...
    con1 = Conviction("Assault on Female", "Class A1 Misdemeanor", date(2015,1, 1), "Randolph County", "14-33")
    con2 = Conviction("PSG", "Class H Felony", date(2015,2, 2), "Randolph County", "14-72")
    con3 = Conviction("PSG", "Class H Felony", date(2015,3, 3), "Randolph County", "14-72")
...
def level3_convictions_sixpoints():
    ...
    con2 = Conviction("PSG", "Class H Felony", date(2015,2, 2), "Randolph County", "14-72")
    con3 = Conviction("PSG", "Class H Felony", date(2015,3, 3), "Randolph County", "14-72")
    con4 = Conviction("PSG", "Class 1 Misdemeanor", date(2015,4, 4), "Randolph County", "14-72")
...
def level3_convictions_ninepoints():
    ...
    con1 = Conviction("PSG", "Class 1 Misdemeanor", date(2015,1, 1), "Randolph County", "14-72")                    # 1 pt
    con2 = Conviction("PSG", "Class H Felony", date(2015,2, 2), "Randolph County", "14-72")                         # 2 pts
    con3 = Conviction("PSG", "Class 1 Misdemeanor", date(2015,3, 3), "Randolph County", "14-72")                    # 1 pt
    con4 = Conviction("PSG", "Class 1 Misdemeanor", date(2015,4, 4), "Randolph County", "14-72")                    # 1 pt
    con5 = Conviction("Telecom Hacking", "Class G Felony", date(2015,5, 5), "Randolph County", "14-113.5")          # 4 pts
...
def level4_convictions_tenpoints():
    ...
    con3 = Conviction("PSG", "Class 1 Misdemeanor", date(2015,3, 3), "Randolph County", "14-72")                    # 1 pt
    con4 = Conviction("PSG", "Class 1 Misdemeanor", date(2015,4, 4), "Randolph County", "14-72")                    # 1 pt
    con5 = Conviction("Second Degree Kidnapping", "Class E Felony", date(2015,5, 5), "Randolph County", "14-39")    # 4 pts
    con6 = Conviction("PSG", "Class 1 Misdemeanor", date(2015,6, 6), "Randolph County", "14-72")                    # 1 pt
...
def level4_convictions_13points():
    ...
    con4 = Conviction("PSG", "Class 1 Misdemeanor", date(2015,4, 4), "Randolph County", "14-72")                    # 1 pt
    con5 = Conviction("Second Degree Kidnapping", "Class E Felony", date(2015,5, 5), "Randolph County", "14-39")    # 4 pts
    con6 = Conviction("Involuntary Manslaughter", "Class F Felony", date(2015,6, 6), "Randolph County", "14-18")    # 4 pts
...
def level5_convictions_14points():
    ...
    con5 = Conviction("Second Degree Kidnapping", "Class E Felony", date(2015,5, 5), "Randolph County", "14-39")    # 4 pts
    con6 = Conviction("Involuntary Manslaughter", "Class F Felony", date(2015,6, 6), "Randolph County", "14-18")    # 4 pts
    con7 = Conviction("PSG", "Class 1 Misdemeanor", date(2015,7, 7), "Randolph County", "14-72")                    # 1 pt
...
def level5_convictions_17points():
    ...
    con1 = Conviction("PSG", "Class 1 Misdemeanor", date(2015,1, 1), "Randolph County", "14-72")                    # 1 pt
    con2 = Conviction("Robbery with Dang Weap", "Class D Felony", date(2015,2, 2), "Randolph County", "14-87")      # 6 pt
    con3 = Conviction("Murder in the 2nd", "Class B1 Felony", date(2015,3, 3), "Randolph County", "14-17(b)")       # 9 pt
    con4 = Conviction("PSG", "Class 1 Misdemeanor", date(2015,4, 4), "Randolph County", "14-72")                    # 1 pt
...
def level5_convictions_17_wb2andC():
    ...
    con1 = Conviction("PSG", "Class 1 Misdemeanor", date(2015,1, 1), "Randolph County", "14-72")                    # 1 pt
    con2 = Conviction("Assault w Deadly WIKISI", "Class C Felony", date(2015,2, 2), "Randolph County", "14-32(a)")  # 6 pt
    con3 = Conviction("Murder in the 2nd", "Class B2 Felony", date(2015,3, 3), "Randolph County", "14-17(c)")       # 6 pt
    con4 = Conviction("PSG", "Class 1 Misdemeanor", date(2015,4, 4), "Randolph County", "14-72")                    # 1 pt
    con5 = Conviction("PSG", "Class 1 Misdemeanor", date(2015,5, 5), "Randolph County", "14-72")                    # 1 pt
    con6 = Conviction("PSG", "Class 1 Misdemeanor", date(2015,6, 6), "Randolph County", "14-72")                    # 1 pt
    con7 = Conviction("PSG", "Class 1 Misdemeanor", date(2015,7, 7), "Randolph County", "14-72")                    # 1 pt
...
def level5_convictions_17_redundant_dates():
    ...
    con3 = Conviction("Murder in the 2nd", "Class B2 Felony", date(2015,3, 3), "Randolph County", "14-17(c)")       # 6 pt
    con4 = Conviction("PSG", "Class 1 Misdemeanor", date(2015,4, 4), "Randolph County", "14-72")                    # 1 pt
    con5 = Conviction("PSG", "Class 1 Misdemeanor", date(2015,4, 4), "Randolph County", "14-72")                    # 0 pt (same as other date)
    con6 = Conviction("PSG", "Class 1 Misdemeanor", date(2015,3, 3), "Randolph County", "14-72")                    # 0 pt (same as other date)
    con7 = Conviction("PSG", "Class 1 Misdemeanor", date(2015,5, 5), "Randolph County", "14-72")                    # 1 pt
    con8 = Conviction("PSG", "Class 1 Misdemeanor", date(2015,6, 6), "Randolph County", "14-72")                    # 1 pt
    con9 = Conviction("PSG", "Class 1 Misdemeanor", date(2015,7, 7), "Randolph County", "14-72")                    # 1 pt
...
def level6_convictions_18points():
    ...
    con1 = Conviction("Possess Meth", "Class I Felony", date(2015,1, 1), "Randolph County", "90-95(d)(2)")          # 2 pts
    con2 = Conviction("Robbery with Dang Weap", "Class D Felony", date(2015,2, 2), "Randolph County", "14-87")      # 6 pt
    con3 = Conviction("Murder First Deg", "Class A Felony", date(2015,3, 3), "Randolph County", "14-17(a)")         # 10 pt
...
def screening():
    ...
    con1 = Conviction("Shoplifting", "Class 3 Misdemeanor", date(2015,1, 1), "Randolph County", "14-72")            # 0 pts
    con2 = Conviction("Simple Assault", "Class 2 Misdemeanor", date(2015,2, 2), "Randolph County", "14-33")         # 0 pt
    screening = [ con1, con2 ]
    return screening
...
def rescreening():
    ...
    con1 = Conviction("misdemeanor death by vehicle", "Class 1 Misdemeanor", date(2015,1, 1), "Randolph County", "20-141.4(a2)")        # 1 pts
    con2 = Conviction("Iimpaired driving", "Class 1 Misdemeanor", date(2015,2, 2), "Randolph County", "20-138.1")                       # 1 pt
    con3 = Conviction("Commercial impaired driving", "Class 1 Misdemeanor", date(2015,3, 3), "Randolph County", "20-138.2")             # 1 pt
    con4 = Conviction("DWLR/I", "Class 1 Misdemeanor", date(2015,4, 4), "Randolph County", "20-28(a1")                                  # 0 pts
...
def one_time_murderer():
    ...
    con1 = Conviction("Murder First Deg", "Class A Felony", date(2015,3, 3), "Randolph County", "14-17(a)")         # 10 pt
